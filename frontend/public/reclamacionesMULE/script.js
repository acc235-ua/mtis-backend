document.getElementById('reclamaciones-mule-form').addEventListener('submit', function (e) {
  ...
  const url = `http://localhost:${port}/reclamaciones?cliente=${encodeURIComponent(cliente)}&seguroId=${encodeURIComponent(seguroId)}&reclamacionId=${encodeURIComponent(reclamacionId)}`;

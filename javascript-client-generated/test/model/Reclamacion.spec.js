...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Reclamacion', function() {
      beforeEach(function() {
        instance = new IncidentManagementApi.Reclamacion();
      });

      it('should create an instance of Reclamacion', function() {
        // TODO: update the code to test Reclamacion
        expect(instance).to.be.a(IncidentManagementApi.Reclamacion);
      });

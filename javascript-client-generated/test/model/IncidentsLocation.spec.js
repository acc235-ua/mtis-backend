...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IncidentsLocation', function() {
      beforeEach(function() {
        instance = new IncidentManagementApi.IncidentsLocation();
      });

      it('should create an instance of IncidentsLocation', function() {
        // TODO: update the code to test IncidentsLocation
        expect(instance).to.be.a(IncidentManagementApi.IncidentsLocation);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Comprobacion', function() {
      beforeEach(function() {
        instance = new IncidentManagementApi.Comprobacion();
      });

      it('should create an instance of Comprobacion', function() {
        // TODO: update the code to test Comprobacion
        expect(instance).to.be.a(IncidentManagementApi.Comprobacion);
      });

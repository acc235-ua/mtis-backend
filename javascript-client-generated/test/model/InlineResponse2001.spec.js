...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2001', function() {
      beforeEach(function() {
        instance = new IncidentManagementApi.InlineResponse2001();
      });

      it('should create an instance of InlineResponse2001', function() {
        // TODO: update the code to test InlineResponse2001
        expect(instance).to.be.a(IncidentManagementApi.InlineResponse2001);
      });
      ...
      it('should have the property policyDetails (base name: "policy_details")', function() {
        // TODO: update the code to test the property policyDetails
        expect(instance).to.have.property('policyDetails');
        // expect(instance.policyDetails).to.be(expectedValueLiteral);
      });

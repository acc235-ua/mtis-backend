...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncidentManagementApi.RegistrarApi();
  });

  describe('(package)', function() {
    describe('RegistrarApi', function() {
      describe('authRegisterPost', function() {
        it('should call authRegisterPost successfully', function(done) {
          // TODO: uncomment, update parameter values for authRegisterPost call
          /*

          instance.authRegisterPost(body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
